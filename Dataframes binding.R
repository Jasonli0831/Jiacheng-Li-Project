...
df_202006_202101_temp <- list.files(path = "directionary for Citi Bike raw data from June 2020 to January 2021", 
                                    pattern = "*.csv", 
                                    full.names = TRUE) %>%
  lapply(read_csv)
...
df_202102_202105_temp <- list.files(path = "directionary for Citi Bike raw data from February 2021 to May 2021", 
                                    pattern = "*.csv", 
                                    full.names = TRUE) %>%
  lapply(read_csv)
...
df_201903_202002_temp <- list.files(path = "directionary for Citi Bike raw data from March 2019 to February 2020", 
                                    pattern = "*.csv", 
                                    full.names = TRUE) %>%
  lapply(read_csv)
